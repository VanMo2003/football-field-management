...
import '../user/show_dialog.dart';
import 'dialog_infor.dart';
...
class _BodyManageState extends State<BodyManage> {
  final SelectedDayStreams selectedDayStreams = SelectedDayStreams();

  @override
  void dispose() {
    super.dispose();
    selectedDayStreams.dispose();
  }
